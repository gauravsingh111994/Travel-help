...
$query="SELECT * from $typo where idc=$idc";
$fetch=mysql_query($query) or die("query cant be executed");
$row=mysql_fetch_assoc($fetch);
echo "<div class='spacer'></div>";
echo"<form action='upcomment1.php?id=$id&idc=$idc&type=$type' method='post'>";
$comment=$row['comment'];
echo "<input type='text' value='$comment' name='comment' style='width:500px;height:50px;'><br>";
